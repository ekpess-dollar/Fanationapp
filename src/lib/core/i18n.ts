...
const en: Dict = {
  ...
  studio_vault: "Vault", studio_tiers: "Subscriptions", studio_fans: "Fans",
...
const fr: Dict = {
  ...
  studio_vault: "Coffre", studio_tiers: "Abonnements", studio_fans: "Fans",
  ...
  switch_to_studio: "Passer au Studio créateur", switch_to_browsing: "Revenir à la navigation", become_creator: "Devenir créateur",
...
const es: Dict = {
  ...
  studio_vault: "Bóveda", studio_tiers: "Suscripciones", studio_fans: "Fans",
  ...
  switch_to_studio: "Cambiar a Estudio de creador", switch_to_browsing: "Volver a Explorar", become_creator: "Convertirse en creador",
...
const de: Dict = {
  ...
  studio_vault: "Tresor", studio_tiers: "Abonnements", studio_fans: "Fans",
  ...
  switch_to_studio: "Zum Creator-Studio wechseln", switch_to_browsing: "Zurück zum Durchsuchen", become_creator: "Creator werden",
...
const pt: Dict = {
  ...
  studio_vault: "Cofre", studio_tiers: "Assinaturas", studio_fans: "Fãs",
  ...
  switch_to_studio: "Mudar para Estúdio do criador", switch_to_browsing: "Voltar a Navegar", become_creator: "Tornar-se criador",
...
const yo: Dict = {
  ...
  studio_vault: "Àpótí ìpamọ́", studio_tiers: "Ìforúkọsílẹ̀", studio_fans: "Onífẹ̀ẹ́",
  ...
  switch_to_studio: "Yí padà sí Ilé-iṣẹ́ Oníṣẹ́", switch_to_browsing: "Padà sí Wíwo", become_creator: "Di oníṣẹ́ àkóónú",
